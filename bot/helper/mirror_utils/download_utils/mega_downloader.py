...
from mega import MegaError, MegaListener, MegaRequest, MegaTransfer, MegaApi
...
def add_mega_download(mega_link: str, path: str, listener):
    ...
    api = MegaApi(MEGA_API_KEY, None, None, "emily-mirror")
    ...
    if any([ZIP_UNZIP_LIMIT, MEGA_LIMIT, STORAGE_THRESHOLD]):
        limit = None
