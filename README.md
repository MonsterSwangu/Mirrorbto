...
<details>
<summary> Click here for Deployement guide for newbie </summary>
...
```
git clone https://github.com/missemily2022/EmilyMirrorBot2 mirrorbot/ && cd mirrorbot
```
...
<details>
 <summary> 3. Click here to open Getting Google OAuth API credential file and token.pickle </summary>
**NOTES**
...
**NOTE**: If you want to use port other than 80, change it in [docker-compose.yml](https://github.com/missemily2022/EmilyMirrorBot2/blob/main/docker-compose.yml) also.
